...
/**
 * A builder to build a Semantic Version either based on an existing one or from
 * scratch.
 *
 ...
 *
 * SemVer nextSemVer = SemVer.builder().startFrom(semVer).removePrerelease().build();
 * }</pre>
 *
 * <h3>Building a new Semantic Version from scratch</h3>
 *
 * <pre>{@code
 * SemVer nextSemVer = SemVer.builder().startFrom(1, 2, 0).setPrerelease("SNAPSHOT").build();
 * }</pre>
 */
public abstract class SemVerBuilder {
    ...
    /**
     * Increases the major version by one and sets minor version and patch version
     * to 0, pre-release version and build metadata will be left as they are.
     *
    ...
    /**
     * Increases the major version by one and sets minor version and patch version
     * to 0, pre-release version and build metadata are removed.
     *
     * @return the current instance of the builder
     * @throws InvalidSemanticVersionException
     *             in case the resulting semantic version would not be valid
    ...
    /**
     * Increases the minor version by one and sets the patch version to 0,
     * pre-release version and build metadata will be left as they are.
     *
     * @return the current instance of the builder
     * @throws InvalidSemanticVersionException
     *             in case the resulting semantic version would not be valid
    ...
    /**
     * Increases the patch version by one, pre-release version and build metadata
    ...
    /**
     * Increases the patch version by one, keeps the current major version and minor
     * version, and pre-release version and build metadata are removed.
     *
     * @return the current instance of the builder
     * @throws InvalidSemanticVersionException
     *             in case the resulting semantic version would not be valid
    ...
    /**
     * Removes the currently set build metadata and leaves all other versions and
     * the pre-release version untouched.
     *
     * @return the current instance of the builder
     */
    ...
    /**
     * Removes the currently set pre-release version and leaves all other versions
     * and the build metadata untouched.
     *
     * @return the current instance of the builder
     */
     ...
     *            the new build metadata to be set
     * @return the current instance of the builder
     * @throws InvalidSemanticVersionException
     *             in case the resulting semantic version would not be valid
     */
     ...
     *
     * @param majorVersion
     *            the new major version to be set
     * @return the current instance of the builder
     * @throws InvalidSemanticVersionException
     *             in case the resulting semantic version would not be valid
     */
     ...
     *
     * @param minorVersion
     *            the new minor version to be set
     * @return the current instance of the builder
     * @throws InvalidSemanticVersionException
     *             in case the resulting semantic version would not be valid
     */
     ...
     *
     * @param patchVersion
     *            the new patch version to be set
     * @return the current instance of the builder
     * @throws InvalidSemanticVersionException
     *             in case the resulting semantic version would not be valid
     */
     ...
     *            the new pre-release version to be set
     * @return the current instance of the builder
     * @throws InvalidSemanticVersionException
     *             in case the resulting semantic version would not be valid
     */
     ...
     *
     * @param major
     *            the major version to start with
     * @param minor
     *            the minor version to start with
     * @param patch
     *            the patch version to start with
     * @return the current instance of the builder
     * @throws InvalidSemanticVersionException
     *             in case the resulting semantic version would not be valid
     */
