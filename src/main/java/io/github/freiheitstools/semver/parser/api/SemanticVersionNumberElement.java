...
/**
 * <p>
 * Enumeration of all elements a semantic version can have.
 * </p>
 */
public enum SemanticVersionNumberElement {
    ...
    /**
     * The dot (.) used to separate major version and minor version of a semantic
     * version
     */
    DOT_BETWEEN_MAJOR_VERSION_AND_MINOR_VERSION,

    /**
     * The dot (.) used to separate minor version and patch version of a semantic
     * version
     */
    DOT_BETWEEN_MINOR_VERSION_AND_PATCH_VERSION,

    /**
     * The hyphen (-) used to separate patch version and a given prerelease version
    ...
    /**
     * The plus (+) used to separate patch version or pre-release version and given
     * build metadata of a semantic version.
     */
