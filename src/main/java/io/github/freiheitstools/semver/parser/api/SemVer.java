...
public interface SemVer {
    ...
    /**
     * Returns a new {@link SemVerBuilder builder instance} to build a new semantic
     * version based on an existing semantic version or from scratch.
     *
    ...
    /**
     * Returns a new {@link SemVerParser parser instance} to parse semantic version
     * from a string.
     *
     ...
     */
    @NonNull Optional<String> getBuild();
     ...
     * @see #isValid()
     *
     * @return The location of the erroneous part of the semamtic version in case of
     *         an invalid semantic version, otherwise an empty
     *         {@linkplain Optional}.
     */
    @NonNull Optional<SemanticVersionNumberElement> getErrorLocation();

    /**
     * <p>
     * Returns the major version of the semantic version in case of a valid semantic
     * version.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the minor version of the semantic version in case of a valid semantic
     * version.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the patch version of the semantic version in case of a valid semantic
     * version.
     * </p>
     *
     ...
     */
    @NonNull Optional<String> getPreRelease();

    /**
     * Returns the given semantic version as it is, independent if it is valid or
     * erroneous.
     *
     * @return the
     */
    @NonNull String getSemanticVersion();
    ...
    /**
     * <p>
     * Checks if the instance represents an invalid semantic version or not
     * </p>
     *
     * @return {@code true} if the instance represents an invalid semantic version,
     *         otherwise {@code false}.
     */
     ...
     * </p>
     *
     * @return {@code true} if the instance represents a valid semantic version,
     *         otherwise {@code false}.
     */
