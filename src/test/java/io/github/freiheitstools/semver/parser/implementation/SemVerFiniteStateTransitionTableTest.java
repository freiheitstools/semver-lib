...
class SemVerFiniteStateTransitionTableTest {
    ...
    void invalidSemanticVersionNumbersAreRecognized(
            String givenSemanticVersion, SemanticVersionNumberElement expectedErrorLocation) throws Throwable {
        ...
        State finalState = classUnderTest
                .getReachedStates()
                .get(classUnderTest.getReachedStates().size() - 1);
