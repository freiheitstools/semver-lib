...
The _Semantic Versioning Parser_ is a Java library for parsing,building, and validating semantic versions according to the https://semver.org/[Semantic Version Specification 2.0.0].
